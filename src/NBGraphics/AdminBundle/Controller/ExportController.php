...
class ExportController extends Controller
{
    ...
    public function exportObservationAction()
    {
        ...
        $headers = array('id','Utilisateur','Date Observation','Heure Observation','Quantite','Maturite','Plumage','Nidification','Taxref','Departement','Latitude','Longitude','Commentaire','Statut','Date de creation');
